...
CREATE TABLE `fan` (
  ...
  CONSTRAINT `fan_ibfk_1` FOREIGN KEY (`favorite_team`) REFERENCES `club` (`club_name`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `fan` VALUES ('omarosman23','omarosman23@aucegypt.edu',0,'2000-01-23','\"\"\"AFC Bournemouth\"\"\"');
